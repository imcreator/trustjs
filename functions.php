<?php
/**
 * trustjs functions and definitions.
 *
...
if ( ! function_exists( 'trustjs_setup' ) ) :
/**
 ...
 */
function trustjs_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on trustjs, use a find and replace
	 * to change 'trustjs' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'trustjs', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'trustjs' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'trustjs_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // trustjs_setup
add_action( 'after_setup_theme', 'trustjs_setup' );
 ...
 */
function trustjs_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'trustjs_content_width', 640 );
}
add_action( 'after_setup_theme', 'trustjs_content_width', 0 );
 ...
 */
function trustjs_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'trustjs' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'trustjs_widgets_init' );
...
function trustjs_scripts() {
	...
	wp_enqueue_script( 'trustjs-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
